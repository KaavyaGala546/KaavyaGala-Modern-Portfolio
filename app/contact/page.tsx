...
/* ─── Data ─── */
const contactInfo = [
    { icon: <Mail size={18} />, label: "Email", value: "kaavyagala@gmail.com", href: "mailto:kaavyagala@gmail.com" },
    { icon: <MapPin size={18} />, label: "Location", value: "India (Mumbai)" },
    { icon: <Clock size={18} />, label: "Response Time", value: "< 2 hours" },
    { icon: <MessageCircle size={18} />, label: "Languages", value: "English, Hindi, French, Gujarati, Kutchi, A few more" },
];

const faqs = [
    { q: "What is your preferred technology stack?", a: "I build primarily in the TypeScript ecosystem. My core stack includes Next.js (App Router), PostgreSQL (Prisma/Drizzle), and Tailwind CSS. For AI-heavy projects, I specialize in RAG architectures using Vector Databases and multi-agent orchestration via LangGraph or CrewAI." },
    { q: "How do you approach a new engineering build?", a: "I focus on 'Architecture First.' Before writing code, I ensure the data model and system design are optimized for scalability. I prioritize type-safety, accessible UI components (shadcn/ui), and robust CI/CD pipelines to ensure the product is production-ready from day one." },
    { q: "Are you only focused on software development?", a: "No. I bring a founder-level strategic mindset to every project. This perspective comes from building my own health snacking brand, Bocadoh, where I handle everything from consumer branding to operational strategy. I don't just ship features; I build systems that drive business value." },
    { q: "What type of projects are you usually interested in?", a: "I partner with teams on mission-critical features, AI integrations, or 0→1 builds. I'm attracted to projects that require deep technical problem-solving and a high degree of craftsmanship, whether it's a seed-stage startup or a scaling enterprise." },
];
...
export default function ContactPage() {
    ...
    const canAdvance = () => {
        switch (step) {
            ...
            case 2: return formData.engagement.length > 0;
                ...
                <section className="mt-8 md:mt-16 mb-8 md:mb-12">
                    ...
                    >
                        ...
                        <p className="font-mono text-sm md:text-base font-bold text-ink/60 max-w-lg leading-relaxed">
                            Looking for an engineering partner to architect your next venture? Whether it&apos;s a complex AI integration or a scalable consumer platform, let&apos;s discuss how we can build something impactful together.
                        </p>
                    </motion.div>
                </section>
                            ...
                            {isSuccess ? (
                                ...
                                >
                                    ...
                                    <div className="flex gap-3 mt-6">
                                        ...
                                        <a href="https://github.com/KaavyaGala546" target="_blank" className="neo-card bg-ink text-cream px-4 py-2 font-mono text-sm font-bold uppercase flex items-center gap-2">
                                            ...
                                            <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                    {engagementOptions.map((e) => (
                                                        <button
                                                            key={e}
                                                            onClick={() => setFormData({ ...formData, engagement: e })}
                                                            className={`neo-card p-4 font-mono text-sm font-bold text-left transition-all ${formData.engagement === e
