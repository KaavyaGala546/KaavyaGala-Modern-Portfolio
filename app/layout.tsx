...
export const metadata: Metadata = {
    title: "Kaavya Gala — Full-Stack Engineer",
    description:
        "Full-stack engineer shipping production-ready products in hours. From native iOS apps to AI-powered agents. Building worldwide.",
    keywords: ["full-stack", "engineer", "developer", "portfolio", "iOS", "AI", "Next.js", "Kaavya Gala"],
    authors: [{ name: "Kaavya Gala" }],
    icons: {
        icon: "/favicon.svg",
    },
    openGraph: {
                    ...
                    <nav className="fixed bottom-0 left-0 w-full bg-ink border-t-[3px] border-ink z-[100] shadow-[0px_-4px_20px_rgba(0,0,0,0.3)]">
                        <div className="max-w-7xl mx-auto px-3 md:px-8 py-2.5 md:py-3 flex justify-between items-center gap-1">
                            ...
                            <MagneticButton>
                                <a
                                    href="/resume.pdf"
                                    download="Kaavya_Gala_Resume.pdf"
