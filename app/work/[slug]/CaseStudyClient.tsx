                ...
                >
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 md:mb-12">
                        <div className="flex-1">
                            ...
                            <h1 className="text-4xl sm:text-6xl md:text-[7rem] font-heading font-bold text-ink leading-[0.85] tracking-tighter uppercase">
                                {project.title}
                            </h1>
                        </div>
                        ...
                        {project.deployedUrl && (
                            <motion.a
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="inline-flex items-center gap-3 px-6 py-4 bg-acid text-ink border-[3px] border-ink font-heading font-bold text-base uppercase tracking-wider shadow-[6px_6px_0_0_#000] hover:bg-ink hover:text-acid transition-colors group h-fit"
                            >
