...
export default function CommandPalette() {
    ...
    const commands: Command[] = [
        ...
        { id: "trajectory", label: "Go to Trajectory", icon: <Code2 size={16} />, action: () => router.push("/trajectory") },
        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        <div className="neo-card bg-cream border-[3px] border-ink shadow-neo overflow-hidden">
                            {/* Search input */}
