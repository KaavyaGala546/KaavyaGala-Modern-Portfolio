...
export const BentoGridItem = ({
    ...
    const content = (
        <motion.div
            ...
            className={cn(
                "relative overflow-hidden group neo-card flex flex-col justify-between p-6 cursor-pointer neo-glow perspective-1000 w-full",
                bgColor,
                textColor,
                className
            )}
        >
            ...
            {/* Content */}
            <div className="relative z-10 mt-auto flex flex-col gap-2 transition-all duration-300 group-hover:text-acid" style={{ transform: "translateZ(40px)" }}>
                <div className="transition-all duration-300 group-hover:drop-shadow-[0_0_15px_rgba(204,255,0,0.8)]">
                    {icon}
                </div>
